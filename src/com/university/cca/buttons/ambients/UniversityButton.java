...
public class UniversityButton extends JButton implements ActionListener {
	...
	private static final String BUTTON_NAME 	= "University";
	private static final String BUTTON_TOOL_TIP = "Create university";
	
	private AppMainFrame parentFrame;
	
    public UniversityButton(AppMainFrame parentFrame) {
